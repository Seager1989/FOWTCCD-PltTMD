...
"Subcomponents/DTU_10MW_InflowWind_v11.4ms.dat"    						InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"Rotor/DTU_10MW_AeroDyn15.dat"									AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"Subcomponents/DTU_10MW_NAUTILUS_GoM_ServoDyn_v11.4ms.dat" 				ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
"Subcomponents/DTU_10MW_NAUTILUS_GoM_HydroDyn_v11.4ms.dat"    			HydroFile       - Name of file containing hydrodynamic input parameters (quoted string)
...
True          SumPrint        - Print summary data to "<RootName>.sum" (flag)
    ...
    default   DT_Out          - Time step for tabular output (s)
        50   TStart          - Time to begin tabular output (s)
...
45.000000, 49.000000   LinTimes    - List of times at which to linearize (s) [1 to NLinTimes] [used only when Linearize=True and CalcSteady=False]
